...
if robust
	db_orig = SQLite3::Database.new( "/home/gsc/test_suj_branch3_import_bug.db" )
	db = SQLite3::Database.new( "/home/gsc/test_suj_branch3_import_#{@@robust_param}_#{@@param}_bug.db" )
else
	db = SQLite3::Database.new( "/home/gsc/test_suj_branch3_import_bug.db" )
end
