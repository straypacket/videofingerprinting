...
if robust
	db_orig = SQLite3::Database.new( "/home/gsc/test_suj_branch3_import.db" )
	db = SQLite3::Database.new( "/home/gsc/test_suj_branch3_import_#{@@robust_param}_#{@@param}.db" )
else
...
=end
	...
	(0..(lumaArraySecCluster.keys.size - 1)).each do |idx|
		...
		if line != ""
			hitCounter += 1 
			uniqCounter << video
			print line if (no_orig && gcount > 0) || !no_orig
		end
