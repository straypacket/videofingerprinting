...
if sqlite
  ...
  db_temp = SQLite3::Database.new( "/home/gsc/test_suj_temp1.db" ) if linux && (( sqlite || sqlite_import ) && sqlite_import_sql)
  db = SQLite3::Database.new( "test.db" ) if !linux
  db = SQLite3::Database.new( "/home/gsc/test_suj_newtable_#{@@param}_lut1.db" ) if linux && ( sqlite || sqlite_import || sqlite_import_sql )
  db = SQLite3::Database.new( "/home/gsc/test_suj_3tablepermovie_#{@@param}_lut1.db" ) if linux && threeTables && ( sqlite || sqlite_import || sqlite_import_sql )
  #
